use rainy_sdk::{
    client::RainyClient,
    models::{
        ChatCompletionRequest, ChatMessage, ThinkingConfig, ThinkingLevel,
        ContentPart, EnhancedChatMessage, model_constants::GOOGLE_GEMINI_3_PRO,
        Tool, ToolType, FunctionDefinition,
    },
    error::RainyError,
};
use serde_json::json;
...
async fn main() -> Result<(), RainyError> {
    ...
    let request = ChatCompletionRequest::new(
        GOOGLE_GEMINI_3_PRO,
        vec![ChatMessage::user("List 5 programming languages and their primary use cases.")]
    )
    ...
    let enhanced_messages = vec![
        ...
        EnhancedChatMessage::with_parts(
            ...
            vec![
                ContentPart::text("Let me think through this systematically...")
                    .as_thought(),
    ...
    println!("Enhanced message structure created with {} parts", 
    ...
    println!("Gemini 3 Pro supports thinking: {}", gemini_3_request.supports_thinking());
    println!("Gemini 3 Pro requires thought signatures: {}", gemini_3_request.requires_thought_signatures());
